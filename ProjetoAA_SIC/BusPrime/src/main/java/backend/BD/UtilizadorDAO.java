...
public class UtilizadorDAO {
	...
	public static boolean save(Utilizador utilizador) throws PersistentException {
		try {
			BusPrimePersistentManager.instance().saveObject(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Utilizador utilizador) throws PersistentException {
		try {
			BusPrimePersistentManager.instance().deleteObject(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Utilizador utilizador) throws PersistentException {
		try {
			BusPrimePersistentManager.instance().getSession().refresh(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Utilizador utilizador) throws PersistentException {
		try {
			BusPrimePersistentManager.instance().getSession().evict(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
