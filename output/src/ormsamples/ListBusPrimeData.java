...
public class ListBusPrimeData {
	...
	public void listTestData() throws PersistentException {
		...
		Bilhete[] bilhetes = Bilhete.listBilheteByQuery(null, null);
		...
		Empresa[] empresas = Empresa.listEmpresaByQuery(null, null);
		...
		Percurso[] percursos = Percurso.listPercursoByQuery(null, null);
		...
		Autocarro[] autocarros = Autocarro.listAutocarroByQuery(null, null);
		...
		ParagemHora[] paragemHoras = ParagemHora.listParagemHoraByQuery(null, null);
		...
		Paragem[] paragems = Paragem.listParagemByQuery(null, null);
		...
		Coordenadas[] coordenadases = Coordenadas.listCoordenadasByQuery(null, null);
		...
		PerguntaFrequente[] perguntaFrequentes = PerguntaFrequente.listPerguntaFrequenteByQuery(null, null);
		...
		Viagem[] viagems = Viagem.listViagemByQuery(null, null);
