...
public class BusPrimePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "BusPrime";
	...
	private BusPrimePersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new BusPrimePersistentManager();
		}
